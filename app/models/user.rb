class User < ActiveRecord::Base
  ...
  has_many :bookmarked_recipes, through: :user_bookmark_recipes, source: :recipe
  ...
  has_many :user_bookmark_collections, dependent: :destroy
  has_many :bookmarked_collections, through: :user_bookmark_collections, source: :collection
